...
{
    public class BodyFatCircumMenConfigurations : IEntityTypeConfiguration<BodyFatCircumMen>
    {
        public void Configure(EntityTypeBuilder<BodyFatCircumMen> builder)
        {
