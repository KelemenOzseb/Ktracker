    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BodyFatCircumMen", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BodyFatCircumWomen", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BodyFatPercentage = table.Column<double>(type: "float", nullable: false),
                    BicepsSkinfold = table.Column<double>(type: "float", nullable: false),
                    TricepsSkinfold = table.Column<double>(type: "float", nullable: false),
                    ScapularSkinfold = table.Column<double>(type: "float", nullable: false),
                    HipSkinfold = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BodyFatFromSkinfolds", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalCaloriesIntake = table.Column<int>(type: "int", nullable: false),
                    TotalBurntCalories = table.Column<int>(type: "int", nullable: false),
                    SummaryCalories = table.Column<int>(type: "int", nullable: false),
                    Weight = table.Column<int>(type: "int", nullable: false),
                    BodyFatPercentage = table.Column<double>(type: "float", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BodyFatCircumMen_UserId",
                table: "BodyFatCircumMen",
                column: "UserId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BodyFatCircumWomen_UserID",
                table: "BodyFatCircumWomen",
                column: "UserID",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BodyFatFromSkinfolds_UserId",
